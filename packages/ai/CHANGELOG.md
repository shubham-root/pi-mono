...
- Route Kimi/Moonshot models on Amazon Bedrock through bedrock-mantle OpenAI-compatible endpoint instead of the Converse API. The Converse API has known tool call parsing bugs for these models (vercel/ai#11409) that cause premature `end_turn` and lost tool calls in multi-step agentic workflows.
